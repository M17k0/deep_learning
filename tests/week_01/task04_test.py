...
from week_01.engineering.task04 import draw_plot_from_walk


class TestDrawPlotFromWalk:

  def test_when_walk_is_provided_then_plot_labels_and_show_are_called(
      self, monkeypatch):
    calls = {
        "plot": False,
        "xlabel": False,
